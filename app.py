            ...
            inputs = [
                {
                    ...
                    "content": [
                        {
                            "type": "text", 
                            "text": "IMPORTANT: First check if this page contains a visible barcode/QR code image.\n\nBarcode Image Present: [YES or NO]\n\nIf NO barcode image is present, respond ONLY with 'Barcode Image Present: NO' and stop.\n\nIf YES barcode image is present, continue with extraction.\n\n---\n\n🚨 EXTRACT ONLY THESE FIXED FIELDS - DO NOT SKIP OR MODIFY FIELD NAMES 🚨\n\nREQUIRED FIELDS (MANDATORY):\n1. Appt Date\n2. Name of Patient \n3. Patient Birthdate (DOB)\n4. Facility Information (Name AND Address together)\n\nBILLING INFORMATION FIELDS:\n5. Primary (Insurance Company)\n6. Sub/Member No.\n7. Group Number\n\nDIAGNOSIS/SYMPTOMS FIELDS:\n8. Diagnosis Codes (ONLY extract medical codes like E11.9, I50.9, I10, etc. - NO descriptions)\n\n---\n\n📋 HOW TO EXTRACT EACH FIELD:\n\n1️⃣ Appt Date:\n   - Look for: \"Appt Date\", \"Appointment Date\", \"Collection Date\", \"Order Date\"\n   - Extract the DATE VALUE only\n   - Format: as shown on document\n\n2️⃣ Name of Patient (REQUIRED - ALWAYS PRESENT ON BARCODE PAGES):\n   - Look for labels: \"Name:\", \"Patient:\", \"Patient Name:\", \"Name of Patient:\"\n   - Copy EXACTLY as printed - NO CHANGES\n   - Example: \"LINDA BONARRIGO\" stays \"LINDA BONARRIGO\" (NOT \"BONARRIGO, LINDA\")\n   - This field is MANDATORY on every barcode page\n\n3️⃣ Patient Birthdate (REQUIRED - ALWAYS PRESENT ON BARCODE PAGES):\n   - Look for labels: \"DOB:\", \"Date of Birth:\", \"Birthdate:\", \"Birth Date:\", \"D.O.B.:\"\n   - Extract the DATE VALUE only\n   - This field is MANDATORY on every barcode page\n\n4️⃣ Facility Information:\n   - Look for: \"Facility:\", \"Facility Name:\", \"Location:\", \"Provider:\"\n   - Extract BOTH name AND address together as one field\n   - Example: \"Alliance Health at Marina Bay, 2 Seaport, Quincy, MA\"\n   - If facility info is split across multiple lines, combine them\n\n5️⃣ Primary (Insurance Company):\n   - Look for: \"Primary:\", \"Insurance:\", \"Primary Insurance:\", \"Insurance Company:\"\n   - Extract the INSURANCE COMPANY NAME only\n   - If not found, leave BLANK\n\n6️⃣ Sub/Member No.:\n   - Look ONLY for these EXACT labels:\n     • \"Sub/Member No.:\"\n     • \"Member ID\"\n     • \"Member No.\"\n     • \"Mem #\"\n     • \"Subscriber ID\"\n   - Extract the VALUE next to the label\n   - If label NOT found, leave COMPLETELY BLANK\n   - ❌ DO NOT copy from other fields\n   - ❌ DO NOT use placeholder text\n\n7️⃣ Group Number:\n   - Look ONLY for these EXACT labels (DIFFERENT from Sub/Member No.):\n     • \"Group Number\"\n     • \"Group #\"\n     • \"Grp #\"\n     • \"Group ID\"\n     • \"Group Code\"\n   - Extract the VALUE next to the label\n   - If label NOT found, leave COMPLETELY BLANK\n   - ❌ DO NOT copy from other fields\n   - ❌ DO NOT use placeholder text\n\n⚠️ CRITICAL: Sub/Member No. and Group Number must be DIFFERENT or one BLANK\n   ❌ ERROR: Both have same value = YOU COPIED!\n   ✅ CORRECT: Different values OR one is blank\n\n8️⃣ Diagnosis Codes:\n   - Extract ONLY the medical codes (E11.9, I50.9, I10, etc.)\n   - Format: code1, code2, code3 (separated by comma and space)\n   - List each code ONCE (no duplicates)\n   - ❌ DO NOT include descriptions or text\n   - ❌ DO NOT include anything other than the codes\n\n---\n\n🚨 EXTRACTION RULES - FOLLOW EXACTLY 🚨\n\n✅ DO THIS:\n- Extract from correct labels only\n- Leave blank if label not found\n- Copy patient name EXACTLY as printed\n- Use only medical codes for diagnosis\n- Keep facility name and address together\n\n❌ DO NOT DO THIS:\n- Copy values between different fields\n- Use placeholder text like \"N/A\", \"[NOT FOUND]\", \"(not printed)\"\n- Modify patient names or rearrange them\n- Split facility information\n- Include descriptions in diagnosis codes\n\n---\n\nReturn in this EXACT format (FIXED FIELD NAMES - DO NOT CHANGE):\nBarcode Image Present: [YES or NO]\nAppt Date: [value or blank]\nName of Patient: [value - REQUIRED]\nPatient Birthdate: [value - REQUIRED]\nFacility Information: [value or blank]\nPrimary: [value or blank]\nSub/Member No.: [value or blank]\nGroup Number: [value or blank]\nDiagnosis Codes: [value or blank]\n\n🔍 VERIFICATION CHECKLIST:\n✓ Name of Patient found? (REQUIRED)\n✓ Patient Birthdate found? (REQUIRED)\n✓ Sub/Member No. and Group Number different or one blank?\n✓ All field names match exactly?\n✓ No placeholder text used?\n✓ Diagnosis codes only (no descriptions)?"
                        },
                        {
                            "type": "image_url",
