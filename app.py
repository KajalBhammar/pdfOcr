        ...
        for page_num, pixmap in enumerate(images, 1):
            ...
            for line in lines:
                if "Appt Date:" in line:
                    ...
                    # Make sure it's not capturing an address or other field
                    if extracted_group and len(extracted_group.strip()) > 0 and "address" not in extracted_group.lower() and "," not in extracted_group:
